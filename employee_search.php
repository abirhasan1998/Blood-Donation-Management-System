...
<div class="employee">
  ...
  <?php
	  ...
	  $SQL = "SELECT * FROM tb_employee WHERE '".$a."' IN (Employee_Id);";
		  $result=mysqli_query($connection,$SQL);
		  if(!$result || mysqli_num_rows($result) > 0)
			{
			  echo "<table><tr><th>Employee_Name</th><th>Employee_Id</th><th>Employee_Designation</th><th>Address</th><th>Contact_No</th></tr>";
