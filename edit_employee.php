...
<div class="php" style="text-align: center; padding-left: 35%;">
 ...
 $con = mysqli_connect('localhost','root','');
   ...
   {
   $sql="SELECT * FROM tb_employee where Employee_Id='$_GET[Employee_Id]'";
   $res=mysqli_query($con,$sql);
     
while($row=mysqli_fetch_array($res))
    {
      echo"<tr><form action='update_employee.php'method=post class='clo'>";
	   echo "<table style='width:500px; margin:0px; color:black;  text-align: center; padding:8px;' border='8' bgcolor='LightCyan '>";
	  echo"<br>";
      echo"<tr><td>Employee_Name </td><td><input type=text name=Employee_Name value='".$row['Employee_Name']."'</td></tr>";
	   echo"<br>";
      echo"<tr><td>Employee_Id    </td><td><input type=text name=Employee_Id value='".$row['Employee_Id']."'</td></tr>";
	   echo"<br>";
       echo"<tr><td>Employee_Designation </td><td><input type=text name=Employee_Designation value='".$row['Employee_Designation']."'</td></tr>";
	    echo"<br>";
