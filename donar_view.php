...
$sql = "SELECT * FROM tb_donar";
$result = $conn->query($sql);


if ($result->num_rows > 0) 
	{
     echo "<table style='width:300px; margin:0px; color:black; padding:8px;' border='8' bgcolor='GhostWhite '>";
      echo"<tr><th colspan='5'><h3>Donar All Information</h3></th></tr>";
	  echo"<tr>";
	  echo"<td><h4>Donar_Name</h4></td>";
	  echo "<td><h4>Donar_Id</h4></td>";
	  echo "<td><h4>Donar_Blood_Group</h4></td>";
     ...
     while($row = $result->fetch_assoc()) {
		// echo"<tr>";
		 //echo"<td>".$row['name']."</td>";
		  //echo"<td>".$row['id']."</td>";
        echo "<tr><td>"  . $row["Donar_Name"]."</td><td>". $row["Donar_Id"]."</td><td>"  . $row["Donar_Blood_Group"]."</td><td>"  . $row["Address"]."</td><td>"  . $row["Contact_No"];
		echo "<td><a href=delete_donar.php?Donar_Id=".$row['Donar_Id'].">Delete</a></td>";
		echo "<td><a href=edit_donar.php?Donar_Id=".$row['Donar_Id'].">Update</a></td>";
		echo "<td><a href=donar_print.php?Donar_Id=".$row['Donar_Id'].">print</a></td>";
		//echo"</tr>";
