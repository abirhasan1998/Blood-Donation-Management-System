...
<div class="php" style="text-align: center; padding-left: 35%;">
 ...
 $con = mysqli_connect('localhost','root','');
   ...
   {
   $sql="SELECT * FROM tb_patient where Patient_Id='$_GET[Patient_Id]'";
   $res=mysqli_query($con,$sql);
     
while($row=mysqli_fetch_array($res))
    {
      echo"<tr><form action='update_patient.php'method=post class='clo'>";
	   echo "<table style='width:500px; margin:0px; color:black;  text-align: center; padding:8px;' border='8' bgcolor='LightCyan '>";
	  echo"<br>";
      echo"<tr><td>Patient_Name </td><td><input type=text name=Patient_Name value='".$row['Patient_Name']."'</td></tr>";
	   echo"<br>";
      echo"<tr><td>Patient_Id     </td><td><input type=text name=Patient_Id value='".$row['Patient_Id']."'</td></tr>";
	   echo"<br>";
       echo"<tr><td>Patient_Blood_Group </td><td><input type=text name=Patient_Blood_Group value='".$row['Patient_Blood_Group']."'</td></tr>";
	    echo"<br>";
