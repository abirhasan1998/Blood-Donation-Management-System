...
if ($result->num_rows > 0) 
	{
     echo "<table style='width:300px; margin:0px; color:black; padding:8px;' border='8' bgcolor='LightBlue  '>";
      echo"<tr><th colspan='5'><h3>Employee All Information</h3></th></tr>";
	  echo"<tr>";
	  echo"<td><h4>Employee_Name</h4></td>";
	  echo "<td><h4>Employee_Id</h4></td>";
      echo "<td><h4>Employee_Designation</h4></td>";
     ...
     while($row = $result->fetch_assoc()) {
		// echo"<tr>";
		 //echo"<td>".$row['name']."</td>";
		  //echo"<td>".$row['id']."</td>";
        echo "<tr><td>"  . $row["Employee_Name"]."</td><td>". $row["Employee_Id"]."</td><td>"   . $row["Employee_Designation"]."</td><td>"  . $row["Address"]."</td><td>" . $row["Contact_No"];
		echo "<td><a href=delete_employee.php?Employee_Id=".$row['Employee_Id'].">Delete</a></td>";
		echo "<td><a href=edit_employee.php?Employee_Id=".$row['Employee_Id'].">Update</a></td>";
		echo "<td><a href=employee_print.php?Employee_Id=".$row['Employee_Id'].">print</a></td>";
		//echo"</tr>";
     }
     echo "</table>";
} else {
